...
public class Reservation  implements ActionListener,FocusListener {
	...
	{
	System.out.println("Connection failed1:"+e1);
	}
	}
	if(e.getSource()==b2)
	{
	...
	{
	System.out.println("Connection failed2:"+e1);
	}
	try
	{
		 Connection con=DriverManager.getConnection("jdbc:ucanaccess://C:\\WORKSPACE\\train_ticket\\src\\train_ticket\\Railway.mdb");
	...
	{
	System.out.println("Connection failed3:"+e1);
	}
	}
	if(e.getSource()==b3)
	{
